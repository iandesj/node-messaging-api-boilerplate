## Node Messaging API Boilerplate

A boilerplate application for building a messaging API using express, mongoose and passport.

## Usage

    git clone https://github.com/iandesj/node-messaging-api-boilerplate.git
    cd node-messaging-api-boilerplate
    npm install
    cp .env.example .env
    npm start
